...
public class AlignmentColl extends Coll<Alignment> {
    ...
    public Alignment getUnionism()
    {
        ...
        alignment.setSymbol("⚜");
        alignment.setStartingNode(MConf.startNodeUnionism);
    ...
    public Alignment getFaithOfEstel()
    {
        ...
        alignment.setSymbol("⚘");
        alignment.setStartingNode(MConf.startNodeEstel);
    ...
    public Alignment getDragonWorship()
    {
        ...
        alignment.setSymbol("༗");
        alignment.setStartingNode(MConf.startNodeDragon);
    ...
    public Alignment getVoidWorship()
    {
        ...
        alignment.setSymbol("∵");
        alignment.setStartingNode(MConf.startNodeVoid);
